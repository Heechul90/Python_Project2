...
model.add(Conv2D(32, kernel_size = (3, 3), padding = 'same', input_shape = (96, 96, 1), activation = 'relu'))
...
## 모델 저장 폴더 설정
Model_dir = 'Project03/model2/'
if not os.path.exists(Model_dir):
    os.mkdir(Model_dir)

## 모델 저장 조건 설정
modelpath = 'Project03/model2/{epoch:02d}-{val_loss:.4f}.hdf5'
